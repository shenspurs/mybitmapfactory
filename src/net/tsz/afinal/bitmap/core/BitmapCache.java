...
public class BitmapCache {
    ...
    //默认的内存缓存大�?    private static final int DEFAULT_MEM_CACHE_SIZE = 1024 * 1024 * 8; // 8MB

    //默认的磁盘缓存大�?    private static final int DEFAULT_DISK_CACHE_SIZE = 1024 * 1024 * 20; // 20MB
...
//        public int diskCacheSize = DEFAULT_DISK_CACHE_SIZE;
      public int memCacheSize = 16*1024*1024;
      public int diskCacheSize = 16*1024*1024;
         ...
         * 设置缓存大小 
         * @param context
         * @param percent 百分比，值的范围是在 0.05 �?0.8之间
         */
